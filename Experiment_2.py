...
def latency_graph():
    ...
    plt.savefig("Latency_bicasting.png")
...
def graphic():
    ...
    plt.savefig("Throughput_bicasting.png")
...
def apply_experiment(car,client,switch):
    ...
    car[0].cmd('ping 200.0.10.2 -c 10 | grep \"time\" | awk -F \' \' \'{print $7}\' >> phase1.data')
